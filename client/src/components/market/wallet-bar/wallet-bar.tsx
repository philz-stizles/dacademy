...
const WalletBar = () => {
  ...
  return (
    <section className="text-white bg-sky-50 border border-sky-200 py-4">
      <Container className="flex justify-between items-center">
        <h1 className="text-base xs:text-xl break-words text-slate-700">
          <span className=' font-bold'>Welcome! Dacademite</span> {account.data && `, ${account.data}`}
        </h1>
        ...
        {requiresInstall && (
          <div className="bg-yellow-500 px-3 py-1 rounded-lg text-sm">
            We cannot connect to network. Please install Metamask.
          </div>
        )}
        {network && (
          <div>
