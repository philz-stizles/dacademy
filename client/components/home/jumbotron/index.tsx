    ...
    <div className=" min-h-[70vh] p-8 flex items-center bg-indigo-50">
      <Container>
        <div className="grid grid-cols-2 place-items-center">
          ...
          <figure className="relative justify-self-end rounded-md overflow-hidden">
            <Image
              className=""
              src="/images/ai-generated-8102806_1280.jpg"
              alt=""
              width={400}
              height={400}
            />
            ...
            {/* <GlassCard className="absolute -bottom-4 left-1/2 -translate-x-1/2">
              <div className="flex flex-col justify-center items-center gap-0.5 text-center">
                <small className="text-xs text-slate-800">20+ Trainers & Instructors</small>
